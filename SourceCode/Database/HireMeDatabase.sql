...
/****** Object:  Database [HireMe]    Script Date: 07-01-2025 11:08:02 ******/
CREATE DATABASE [HireMe]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'HireMe', FILENAME = N'C:\HireMeDatabase\HireMe.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'HireMe_log', FILENAME = N'C:\HireMeDatabase\HireMe_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [HireMe] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [HireMe] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [HireMe] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [HireMe] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [HireMe] SET QUERY_STORE = OFF
GO
